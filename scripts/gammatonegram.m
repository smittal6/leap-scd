...
for i =1:1%len
display([i len])
%[sig,Fs] = audioread(strcat('/home/neerajs/work/Overlap_Corpus/TRAIN_REVV3_NOISE_FULL_DB/',f{1}{i},'.wav'));
...
if get_mel
    ...
    STFTmag=STFTmag';
%    STFTmag = 20*log10(STFTmag);
end

%writehtk(strcat('/home/neerajs/work/NEW_REGIME/SID/FEATS/linear/val/',filename(i).name(1:end-4),'.htk'),STFTmag,0.01,9);
%clearvars STFTmag
