...
addr='/home/siddharthm/scd/feats/mfcc/test/'#address of the HTK files stored somewhere
kurt_addr='/home/siddharthm/scd/feats/kurt/test/'
sfm_addr='/home/siddharthm/scd/feats/sfm/test/'
...
file_read='/home/siddharthm/scd/lists/testfiles/'+str(sys.argv[1]) #The raw filenames, in the form of list
filename='test-mfcc-kurt-sfm-labels-'+str(sys.argv[2]) #The name of the file where stuff is going to be stored
