...
num=20*13+1+1 #The length of the feature vector, to be read and stored in the htk format[Right now,20*39 MFCC + 1 Label + 1 gender]
file_read='/home/siddharthm/scd/lists/'+str(sys.argv[2]) #The raw filenames, in the form of list
filename='200-mfcconly-labels-gender-'+str(sys.argv[3]) #The name of the file where stuff is going to be stored
save_extra='200-mfcconly-extra-'+str(sys.argv[3])+'.txt' #For saving the count of lables
